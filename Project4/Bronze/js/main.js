...
window.addEventListener("DOMContentLoaded", function()
{
    ...
    function makeLifeguards()
	{
        ...
        function editEachLifeguard()//grabs the data from our item from local storage 
        {
            ...
            getElement('cprDate').value = item.cprDate[1];
            getElement('firstAidDate').value = item.firstAidDate[1];
            getElement('lifeguardDate').value = item.lifeguardDate[1];
            ...
            getElement('slide').value = item.slide[1];
                ...
                getElement('checkIn').value = "Save"; //Change submit button value to edit button
